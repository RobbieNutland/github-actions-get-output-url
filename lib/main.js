...
const fetch = __importStar(require("node-fetch-cjs"));
...
function run() {
    return __awaiter(this, void 0, void 0, async function* () {
        try {
            ...
            const auth = octokit.createTokenAuth(token);
            ...
            const { data: authorizations } = await octokit.requestWithAuth(`POST /repos/${owner}/${repo}/actions/workflows/${workflow_id}/dispatches`);

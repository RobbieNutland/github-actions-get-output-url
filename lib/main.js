...
async function run() {
    // return __awaiter(this, void 0, void 0, async function* () {
        try {
            ...
            // // Execute workflow.
            console.log(`Executing: POST /repos/${owner}/${repo}/actions/workflows/${workflow_id}/dispatches`)
            test = await octokit.request('POST /repos/${owner}/${repo}/actions/workflows/Retrieve%20Content.yml/dispatches', {
                owner: owner,
                repo: repo,
